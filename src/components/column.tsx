...
export const ColumnComponent = forwardRef<HTMLDivElement, ColumnProps>(
  ({ column, tasks, boardId, onTaskMove }, ref) => {
    ...
    const [{ isOver }, drop] = useDrop({
      ...
      drop: (item: { id: number; columnId: number }) => {
        ...
        updateTaskColumn(item.id, column.id, tasks.length)
      },
      collect: (monitor) => ({
    ...
    const setRefs = useCallback(
      (element: HTMLDivElement | null) => {
        ...
        // Call the drop ref from React DnD
        drop(element)
